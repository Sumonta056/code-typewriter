...
<template>
  <div class="min-h-screen">
    <OverlayIntroOverlay />
    <div
      class="app max-w-[1440px] mx-auto px-[24px] pt-[20px] pb-[12px] h-screen overflow-hidden flex flex-col max-[768px]:px-[12px] max-[768px]:pt-[10px] max-[480px]:px-[8px] max-[480px]:pt-[8px]"
    >
      <nav
        class="flex items-center justify-between mb-[12px] gap-[8px] max-[900px]:items-start max-[900px]:flex-col"
      >
        <div class="flex items-center gap-[4px] flex-wrap">
          ...
          <NuxtLink to="/rules" class="nav-link" active-class="active"> Rules </NuxtLink>
      ...
      <footer class="app-footer">
        <span class="app-footer__made">made by</span>
        <a
        ...
        <a
          href="https://www.linkedin.com/in/sumonta-saha-mridul-b35bb61a0/"
          target="_blank"
          rel="noopener noreferrer"
          class="app-footer__social"
          aria-label="LinkedIn"
